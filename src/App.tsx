        ...
        {(() => {
          ...
          return (
            <>
              ...
              <div className="loan-contract-sheet w-full bg-white rounded-[32px] border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] text-left relative overflow-hidden" style={{ fontFamily: "'Khmer OS Siemreap', 'Times New Roman', 'Tinos', 'Kantumruy Pro', serif", fontSize: '13px', color: '#1e293b', lineHeight: 1.6, padding: '20px 26px' }}>
                ...
                <p style={{ margin: '5px 0' }}>ភាគី(ខ)ទទួលកម្ចីឈ្មោះ <input value={repBorrower} onChange={(e) => setRepBorrower(e.target.value)} style={{ ...ctIn, width: '110px' }} /> លេខកូដ <input value={repBorrowerId} onChange={(e) => setRepBorrowerId(e.target.value)} style={{ ...ctIn, width: '64px' }} /> ភេទ <input value={ctBGender} onChange={(e) => setCtBGender(e.target.value)} style={{ ...ctIn, width: '54px' }} /> អាយុ <input value={ctBAge} onChange={(e) => setCtBAge(e.target.value)} style={{ ...ctIn, width: '44px' }} /></p>
                <p style={{ margin: '5px 0' }}>ថ្ងៃ ខែ ឆ្នាំកំណើត <input value={ctBDob} onChange={(e) => setCtBDob(e.target.value)} style={{ ...ctIn, width: '120px' }} /> កាន់អត្តសញ្ញាណប័ណ្ណលេខ <input value={ctBIdCard} onChange={(e) => setCtBIdCard(e.target.value)} style={{ ...ctIn, width: '140px' }} /></p>
                <p style={{ margin: '5px 0' }}>អាសយដ្ឋានបច្ចុប្បន្ន <input value={ctBAddress} onChange={(e) => setCtBAddress(e.target.value)} style={{ ...ctIn, width: '330px' }} /></p>
                <p style={{ margin: '5px 0' }}>មុខរបរ <input value={ctBJob} onChange={(e) => setCtBJob(e.target.value)} style={{ ...ctIn, width: '150px' }} /> នៅស្ថាប័ន <input value={ctBOrg} onChange={(e) => setCtBOrg(e.target.value)} style={{ ...ctIn, width: '150px' }} /></p>
                <p style={{ margin: '5px 0' }}>លេខទូរស័ព្ទ <input value={repPhone} onChange={(e) => setRepPhone(e.target.value)} style={{ ...ctIn, width: '110px' }} /> អ៊ីម៉ែល <input value={ctBEmail} onChange={(e) => setCtBEmail(e.target.value)} style={{ ...ctIn, width: '160px' }} /></p>
                <p style={{ margin: '5px 0', textAlign: 'justify' }}>បានខ្ចីប្រាក់ចំនួន <b>${fmt2(parseFloat(repLoanAmt) || 0)}</b> ជាអក្សរ <input value={ctAmtWords} onChange={(e) => setCtAmtWords(e.target.value)} style={{ ...ctIn, width: '230px' }} /> ពីក្រុមសន្សំប្រាក់អនាគតយើង ដែលរយៈពេលនៃការខ្ចី និងសងត្រលប់មកវិញមានរយៈពេល <input type="number" value={repLoanTerm} onChange={(e) => setRepLoanTerm(parseInt(e.target.value) || 0)} style={{ ...ctIn, width: '44px' }} /> ខែ ដោយគិតចាប់ពីថ្ងៃផ្ដិតមេដៃលើកិច្ចសន្យានេះ។</p>
                <p style={{ margin: '5px 0' }}>មូលហេតុនៃការខ្ចីប្រាក់៖ <input value={repPurpose} onChange={(e) => setRepPurpose(e.target.value)} style={{ ...ctIn, width: '320px' }} /></p>
                <p style={{ margin: '5px 0' }}>កំណត់សំគាល់៖ <input value={ctRemark} onChange={(e) => setCtRemark(e.target.value)} style={{ ...ctIn, width: '380px' }} /></p>

                <p style={{ textIndent: '2em', textAlign: 'justify', margin: '7px 0 5px' }}>អាស្រ័យហេតុដូចបានជម្រាបជូនខាងលើ សូមគណៈកម្មាការ និងអ្នកគ្រប់គ្រងក្រុមសន្សំ មេត្តាឱ្យ ខ្ញុំបាទ / នាងខ្ញុំ បានខ្ចីនូវចំនួនទឹកប្រាក់ដែលបានកំណត់ខាងលើ។ ក្នុងករណី ខ្ញុំបាទ / នាងខ្ញុំ រំលោភបំពានលើសេចក្តីទុកចិត្ត ឬមិនគោរពតាមគោលការណ៍នៃការខ្ចីសង ខ្ញុំបាទ / នាងខ្ញុំ សុខចិត្តទទួលខុសត្រូវចំពោះមុខច្បាប់។</p>
                <p style={{ textIndent: '2em', textAlign: 'justify', margin: '5px 0' }}>ក្នុងករណីដែលអ្នកខ្ចីមិនមានលទ្ធភាពសងត្រលប់ប្រាក់មកក្រុមសន្សំវិញ អ្នកអាណាព្យាបាល / ប្ដី / ប្រពន្ធ ដែលបានផ្ដិតមេដៃ ជាអ្នកទទួលខុសត្រូវក្នុងការសងត្រលប់មុនគេ។ ក្នុងករណី កម្ចីមិនមានអ្នកអាណាព្យាបាល / ប្ដី / ប្រពន្ធជាអ្នកធានា នោះអ្នកធានាទាំងបីនាក់ដែលបានផ្ដិតមេដៃនឹងទទួលខុសត្រូវក្នុងការសងត្រលប់ម្នាក់ពាក់កណ្ដាល នៃកម្ចីដែលនៅសល់។</p>
